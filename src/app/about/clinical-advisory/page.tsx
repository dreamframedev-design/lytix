...
const advisoryBoard = [
  {
    name: "James Wooldridge",
    title: "Clinical Advisor",
    bio: "Renowned oncologist with extensive experience in melanoma and immunotherapy clinical trials, providing strategic clinical guidance to Lytix Biopharma.",
  },
  {
